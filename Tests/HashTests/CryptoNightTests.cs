...
namespace Tests
{
    ...
    public class CryptoNightTests
    {
        ...
        public void TestCryptoNight()
        {
            ...
            string actualOutput1 = Encoding.ByteArrayToHexString(CryptoNight.CryptoNightVersionZero(input1));
            ...
            string actualOutput2 = Encoding.ByteArrayToHexString(CryptoNight.CryptoNightVersionZero(input2));
            ...
            string actualOutput3 = Encoding.ByteArrayToHexString(CryptoNight.CryptoNightVersionZero(input3));
            ...
            string actualOutput4 = Encoding.ByteArrayToHexString(CryptoNight.CryptoNightVersionZero(input4));
            ...
            string actualOutput5 = Encoding.ByteArrayToHexString(CryptoNight.CryptoNightVersionZero(input5));
