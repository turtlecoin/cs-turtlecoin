...
namespace Tests
{
    ...
    public class KeyTests
    {
        ...
        {
            PrivateKey p = new PrivateKey(Encoding.HexStringToByteArray(
                "677e019be0351443ea8904a6d6786056f7390eb74ba05ec327bccf2d318ca809"
            ));

            PublicKey pubViewKey = new PublicKey(Encoding.HexStringToByteArray(
                "09e9c339bd1d751bf88d4d2301daa75576297e2e6b1a133cc0b9f03355421f69"
            ));

            PrivateKey privViewKey = new PrivateKey(Encoding.HexStringToByteArray(
                "508ba238625600b2ddec49eef1f114002c76c1436d4a144c3588069c3f72ae02"
            ));
        ...
        public void TestPrivateKeyToPublicKey()
        {
            ...
            PrivateKey a1 = new PrivateKey(Encoding.HexStringToByteArray(
                "3a8441fa686f3d0c01b60264a79153c41fdd925ae4a31ffab215648f00758101"
            ));

            PublicKey a2 = new PublicKey(Encoding.HexStringToByteArray(
                "8464c6ff818fb7f502e4533c23f6ddb615b3568dbbfe954d07f8dd8fd23aefb3"
            ));
            ...
            /* Two completely unrelated keys */
            PrivateKey b1 = new PrivateKey(Encoding.HexStringToByteArray(
                "a8219da64ddb1974292a19b6f2a3d3ef411a592191590d21ac59961c8af0c50e"
            ));

            PublicKey b2 = new PublicKey(Encoding.HexStringToByteArray(
                "45266e9d6259817e6c38cdd7f774fc38c9596d7400b1728546cf111e342941a5"
            ));
