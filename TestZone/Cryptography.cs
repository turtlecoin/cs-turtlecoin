...
namespace TestZone
{
    partial class Program
    {
        ...
        static void TestCryptography()
        {
            ...
            // CNv0 the generated bytes
            byte[] CryptoNightVersionZeroBytes = CryptoNight.CryptoNightVersionZero(Bytes);

            // Write CNv0 bytes to console
            Console.WriteLine($"CNv0: {Encoding.ByteArrayToHexString(CryptoNightVersionZeroBytes)}");
